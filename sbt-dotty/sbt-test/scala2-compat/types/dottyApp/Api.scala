...
class Z {
  ...
  def a_x1(a: A with B with Rec2): Unit = {}
  ...
  def a_x3(a: F1 @foo with Rec4): Unit = {}
  def a_x4(a: F1 with Rec4): Unit = {}
  def a_x5(a: F2 @foo with Rec4): Unit = {}
  def a_x6(a: F2 with Rec4): Unit = {}
  ...
  def a_100(x: structural4a.M[Any] with structural4b.N): Unit = {}

  type Bla = A { type M[X] <: A }
  def a_101(x: Bla#M[Any] with ({ type N <: B with Bla#M[Int] })#N): Unit = {}
  type AEq = A

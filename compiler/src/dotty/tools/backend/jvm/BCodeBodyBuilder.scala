    ...
    def genStat(tree: Tree): Unit = {
      ...
      tree match {
        case Assign(lhs @ Select(qual, _), rhs) =>
          ...
          lineNumber(tree)
          // receiverClass is used in the bytecode to access the field. using sym.owner may lead to IllegalAccessEr
        ...
        case app @ Apply(fun, args) =>
          ...
          if (sym.isLabel) { // jump to a label
            ...
            if (isArrayClone(fun)) {
              ...
              //   http://hg.openjdk.java.net/jdk8/jdk8/hotspot/file/87ee5ee27509/src/share/vm/interpreter/linkReso
